...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var slug, signer, deployer, address;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prompt_promise_1["default"]('slug: ')];
                case 1:
                    slug = _a.sent();
                    if (slug.indexOf(' ') > -1) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, deployer.deploy({
                            alchemillaEngine: __1.xanthoceras.get('engine'),
                            dai: dai
                        })];
                case 3:
                    address = (_a.sent()).address;
                    __1.xanthoceras.set("overseer." + slug, address);
                    return [2 /*return*/];
            }
        });
    });

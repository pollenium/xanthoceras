        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    reader = new pollenium_alchemilla_1.EngineReader({ provider: provider_1.provider, address: address });
                    _a = {};
...
exports.fetchEngineState = fetchEngineState;

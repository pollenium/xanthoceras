...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    engine = new pollenium_buttercup_1.Address(forgetmenot_1.forgetmenot.get('engine'));
                    monarchicExecutorOracle = new pollenium_buttercup_1.Address(forgetmenot_1.forgetmenot.get('monarchicExecutorOracle'));
